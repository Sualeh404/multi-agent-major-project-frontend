...
def build_graph():
    """Build the main synthesis graph: Librarian → Analyst → Critic → Synthesizer.

    RAGAS evaluation is no longer in the realtime flow — it's exposed as an
    optional /audit endpoint that users can invoke explicitly.
    """
